...
const EVENTS_CHAPTER_PARAGRAPHS = [
  "\"One cider, please, and a side of caviar, if you don't mind,\" said the woman.",
  "\"Certainly,\" said the waiter.",
  "\"Say, odd question, but have you ever met a finicky-looking guy here before? Very type A?\"",
  "\"I believe I'm unable to disclose that information.\"",
  "\"My apologies, attendant. I hadn't meant to be so invasive,\" she responded in a lighthearted tone.",
  "\"I'm his friend, you see. Although, with that being said, he hates people knowing that, hence why I'm sitting alone at this table. How many years have you been working here?\"",
  "\"It's been around a year, I'd say.\" Something about her brought out an amenability in the waiter that the other customers rarely saw.",
  "\"A year and two months, actually. You started on a Tuesday. I'm sure it must have been rough, coming from your... persuasion.\"",
  "As soon as she said it, the waiter was dispelled from her charm, filled with a lingering sense of mild spite instead. \"It actually really wasn't,\" they replied sharply. \"It doesn't affect me. It's actually not my problem.\" They didn't remember telling her when they'd started.",
  "\"Of course it's not, I misspoke. Please go inside the kitchen, there should be a small fridge. Please take any drink out of there, on me.\"",
  "\"No offense taken, truly,\" the waiter said untruthfully. \"How do you know about a fridge?\" they remarked.",
  "\"When you shake as many hands as I do, you tend to know how to get what you want,\" she chuckled.",
  "Going to the hatch in the private room, the waiter knocked with confidence, saying, \"One cider and caviar for the woman on table nine.\" There were no table numbers, but the waiter found solace in calling it out, as it gave a sense of normalcy to their job working in a restaurant that was fundamentally, yet indescribably, wrong.",
  "As the waiter returned to the table with her order, the woman masked her deep disappointment with a warm smile and asked, \"No drink for yourself?\" Her eyes had flicked to the private room a beat too long before landing back on the waiter, as if she'd been expecting the door to stay shut.",
  "Matching her playful tone, the waiter replied, \"Well, how do you know I didn't take a drink when you weren't looking?\"",
  "\"I would know,\" she said seriously. \"Give me my dish now. I'm starving.\" Any cordiality left in her voice had all but dissolved once she saw the food.",
  "\"Everyone at this table gets something in the end,\" she said, almost to herself, eyes on the plate. \"That's the whole arrangement.\"",
  "The waiter had forgotten that, ultimately, this was an exchange.",
];
